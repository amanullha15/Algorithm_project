...
int main()
{
    ...
    printf("This is your set of cloths\n");
    ...
    while(exitcounter!=1)
    {
        ...
        case 0 ... 25:
            ...
            for (i=0; i<10; i++)
            {
                ...
                {
                    printf("Wrong selected. Please try again\n");
                }
                else
                {
...
void get_dressed(int tmp[],int x,int unavailable[],int ucount)
{
    ...
    if(x==0)
    {
        printf("No clothing available this moment.\n");
    }
    else
    {
        printf("Suitable clothes for this weather are:\n");
        for(y=0; y<x; y++)
        {
